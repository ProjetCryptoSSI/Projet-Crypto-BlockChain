...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    if(networkData) {
      ...
      const res = await authentification.methods.diplomes(diplomeCount)
      console.log("helloooooo ", res)
      //console.log(authentification.methods.getHash(res))
  ...
  constructor(props) {
    ...
    this.createDiplome = this.createDiplome.bind(this)
   
  }
  createDiplome(nom,prenom,matricule,specialite,niveau) {

    this.setState({ loading: true })
    this.state.authentification.methods.createDiplome(nom,prenom,matricule,specialite,niveau).send({ from: this.state.account })
            ...
            <main role="main" className="col-lg-12 d-flex">
              { this.state.loading
                ...
                : <GenererDiplome 
                      ...
                      createDiplome = {this.createDiplome}
